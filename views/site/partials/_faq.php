...
?>
 <section class="how_it_works" id="how-it-works-section">
        <div class="content-header">
            <h2>How Plasma Ghar Works?</h2>
        </div>
        <div class="container ">
            <div class="row">
                    ...
                    <div class="container row">
                        <div class="col-md-5 offset-md-1 rounded cus-process text-center">
                            ...
                            <p>Even if you are on the <strong>recovery process</strong>, you can add your details by
                                ...
                                search list. So, your details are always welcome.
                            </p>
                        </div>
                        <div class="col-md-5 offset-md-1 rounded cus-process text-center">
                ...
                <div class="col-md-6 cus-hor-border aos-init" data-aos="fade-left">
                    ...
                    <div class="container row">
                        ...
                        <div class="col-md-5 offset-md-1  rounded cus-process text-center">
                            ...
                            <p>Once you've received donation, now its your responsibility to <strong>change your status
                                    to
                                    "DONATION RECEIVED"</strong>. This will be helpful to us so that we can now remove
                                your request
